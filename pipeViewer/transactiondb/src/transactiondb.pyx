...
cdef extern from "TransactionDatabaseInterface.hpp" namespace "sparta::argos":

    ctypedef uint32_t const_interval_idx "sparta::argos::TransactionDatabaseInterface::const_interval_idx const"
    ##ctypedef callback_fxn "sparta::argos::TransactionDatabaseInterface::callback_fxn"
    ...
    cdef cppclass c_TransactionDatabaseInterface "sparta::argos::TransactionDatabaseInterface":
...
cdef extern from "TransactionDatabaseInterface.hpp" namespace "sparta::argos::TransactionDatabaseInterface":
