...
cdef extern from "sparta/argos/transaction_structures.hpp":
...
cdef extern from "TransactionInterval.hpp" namespace "sparta::argos":

    cdef cppclass c_TransactionInterval_uint64_t "sparta::argos::transactionInterval<uint64_t>":
...
cdef extern from "ISL/IntervalList.hpp" namespace "ISL":
    ...
    cdef cppclass c_IntervalListElt "ISL::IntervalList<sparta::argos::transactionInterval<uint64_t>>::IntervalListElt":
    ...
    cdef cppclass c_IntervalList "ISL::IntervalList<sparta::argos::transactionInterval<uint64_t>>":
...
cdef extern from "IntervalWindow.hpp" namespace "sparta::argos":

    cdef cppclass c_IntervalWindow "sparta::argos::IntervalWindow":
