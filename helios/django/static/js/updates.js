...
document.onkeydown = function(evt) {
    ...
    const shpDirectories = ['/sarc-c/spa_users/nicholas.haw/git/helios/prototyping/python-processing/data-sources/data/'];
    const simDbDirectories = ['/sarc-c/spa_users/j.gross/git/helios/django'];
    if (evt.keyCode == 84) {
