...
from helios.backend.adapters.pevent_trace.adapter import PeventTraceAdapter
from helios.backend.adapters.sparta_statistics.adapter import SpartaStatisticsAdapter
from helios.backend.common import logtime, synchronized, synchronizedFine, countactive
from helios.backend.datasources.branch_training_trace.datasource import BranchTrainingDatasource
from helios.backend.datasources.pevent_trace.datasource import PeventDataSource
from helios.backend.datasources.sparta_statistics.datasource import SpartaDataSource
from helios.backend.processors.branch_training_heatmap.adapter import BranchTrainingHeatMapAdapter
from helios.backend.processors.branch_training_heatmap.generator import BranchTrainingHeatMapGenerator
from helios.backend.processors.branch_training_line_plot.generator import BranchTrainingLinePlotGenerator
from helios.backend.processors.branch_training_profile.generator import BranchTrainingProfileHtmlGenerator
from helios.backend.processors.branch_training_table.generator import BranchTrainingListHtmlGenerator
from helios.backend.processors.general_line_plot.generator import GeneralTraceLinePlotGenerator
from helios.backend.processors.pevent_trace_generator.generator import PeventTraceGenerator
from helios.backend.processors.sparta_statistics.generator import SpartaStatsGenerator
from helios.backend.units import Units
from .models import DataId, ProcessorId, LongFunctionCall

logger = logging.getLogger("helios.backend.bpEndpoint")


class bpEndpoint(AsyncWebsocketConsumer):
    '''
    this is the endpoint for most of the data operations that happen in helios
