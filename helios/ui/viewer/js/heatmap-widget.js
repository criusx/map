    ...
    constructor(el, id) {
        ...
        const content = `
            <div style="display:grid; width:100%; height:100%; grid-template-rows:90px 1fr 20px; grid-template-columns: auto 120px 1fr 10px; grid-template-areas: 'top-left top-left top .......' 'far_left left main right' 'far_left left_txt main_txt right_txt';">
              <div id="${this.heatmap_info_name}" class="helios-hm-grid-box helios-hm-top" style="grid-area: top-left; min-height:0px; min-width:0px; padding: 2px;"></div>
              <div id="${this.heatmap_row_chart_name}" class="helios-hm-grid-box helios-hm-top" style="grid-area: top; min-height:0px; min-width:0px;"></div>
              <div id="${this.heatmap_table_stats_name}" class="helios-hm-grid-box helios-hm-top" style="grid-area: far_left; min-height:0px; min-width:0px;"></div>
              <div id="${this.heatmap_table_chart_name}" class="helios-hm-grid-box helios-hm-left" style="grid-area: left; min-height:0px; min-width:0px;"></div>
              <div id="${this.heatmap_div_name}" class="helios-hm-grid-box helios-hm-main" style="grid-area: main; min-height:0px; min-width:0px;"></div>
              <div class="helios-hm-grid-box helios-hm-right" style="grid-area: right;">
